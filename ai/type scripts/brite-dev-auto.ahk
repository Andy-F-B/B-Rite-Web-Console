; brite-brain-dev-script.ahk
; Hotkey: Ctrl+Alt+B — inserts brain phrase + *dev* br : { on next line
...
^!b::
Send, Read [root/ai/brain.md] then proceed; {Shift Down}{Enter}{Shift Up}*dev* br : { {Space}
return
